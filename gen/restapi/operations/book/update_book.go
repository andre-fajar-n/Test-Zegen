...
type UpdateBookHandlerFunc func(UpdateBookParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn UpdateBookHandlerFunc) Handle(params UpdateBookParams, principal *models.Principal) middleware.Responder {
	return fn(params, principal)
}

// UpdateBookHandler interface for that can handle valid update book params
type UpdateBookHandler interface {
	Handle(UpdateBookParams, *models.Principal) middleware.Responder
}
...
/*
	UpdateBook swagger:route PUT /v1/book/{book_id} book updateBook
