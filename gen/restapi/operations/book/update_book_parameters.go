...
type UpdateBookParams struct {
	...
	*/
	...
	/*
	  ...
	  In: body
	*/
	Data *models.UpdateBookParamsBody
}
...
func (o *UpdateBookParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.UpdateBookParamsBody
...
func (o *UpdateBookParams) bindBookID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
